...
export const metadata: Metadata = {
  title: "AI Research",
  description:
    "Explore Nexus Inc. research in artificial intelligence, natural language processing, speech and audio intelligence, computer vision, machine learning and responsible AI.",
  alternates: {
    canonical: "https://nexusinc.rw/research",
  },
  openGraph: {
    title: "AI Research | Nexus Inc.",
    description:
      "Explore Nexus Inc. research in artificial intelligence, natural language processing, speech and audio intelligence, computer vision, machine learning and responsible AI.",
    url: "https://nexusinc.rw/research",
    siteName: "Nexus Inc.",
    type: "website",
  },
  twitter: {
        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
          {researchAreas.map((area) => (
            ...
            >
              ...
              <p className="leading-8 text-gray-300">{area.description}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      <section className="border-t border-white/10 py-24">
        <div className="mx-auto max-w-5xl px-6 text-center">
          ...
          <p
            ...
            style={{ fontFamily: "Times New Roman, serif" }}
          >
            At Nexus Inc., research is more than academic exploration—it is the
            engine behind every platform, every intelligent model, and every
            innovation we bring to the market. Our commitment is to transform
            scientific knowledge into technologies that solve meaningful
